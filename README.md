...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gitignore-parser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13295&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gitignore-parser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gitignore-parser` can be installed with:

```
conda install gitignore-parser
```

It is possible to list all of the versions of `gitignore-parser` available on your platform with:
